...
entry.place(relx=0, rely=.05, relwidth=0.8 ,relheight= 0.15)
entry['font'] = myFont

power = tk.Button(root, bg="#2c3531", text="On/Off" , fg='#116466', command=powerfun)
power.place(relx=0.8, rely=.05, relwidth=0.2 ,relheight= 0.15)
power['font'] = font.Font(size=30)
